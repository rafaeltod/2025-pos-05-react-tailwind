        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <a href="#" className="bg-white/5 group rounded flex items-center gap-4 overflow-hidden hover:bg-white/10 transition-colors">
              ...
              <strong>1989 (Taylor Version) DELUXE </strong>
          ...
          <h2 className="font-semibold text-2xl mt-10">Made for Rafael Tod</h2>
          <div className="grid grid-cols-8 gap-4 mt-4">
            <a href="#" className="bg-white/5 p-3 rounded-md flex flex-col gap-2 hover:bg-white/10 transition-colors">
              ...
              <span className="text-sm text-zinc-400">Kendrick Lamar, Kanye West, Lana del Rey and more</span>
            </a>
            <a href="#" className="bg-white/5 p-3 rounded-md flex flex-col gap-2 hover:bg-white/10 transition-colors">
              <Image src="/album.jpg" className="w-full" width={120} height={120} alt="Capa do álbum da Taylor Swift" />
              <strong className="font-semibold">Daily Mix 1</strong>
